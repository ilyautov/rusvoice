...
⚠️ **Windows.** Вывод всегда в UTF-8, независимо от кодировки консоли — иначе русский текст
ронял бы команду. Если читаете вывод из своего кода, укажите кодировку явно:
